...
- **173 Personajes** documentados con relaciones complejas
...
- **`/characters/`** - 173 fichas de personajes detalladas
...
- **Contar personajes**: Usar `find /docs/characters/details/ -name "*.md" | wc -l` (173 actual)
