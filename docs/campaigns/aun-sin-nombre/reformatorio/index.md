...
<div style="margin: 20px 0;">
  ...
  <div style="margin-top: 15px; text-align: center; font-size: 14px; color: #666;">
    <p>
      <a href="./reformatorio-diagram.json" download>⬇️ Descargar datos JSON</a> |
      <a href="./tldraw-viewer.html" target="_blank">🔗 Abrir en ventana completa</a>
    </p>
  </div>
</div>
...
Los 13 internos están ordenados del más joven al mayor:

1. **LUNA** (8 años) - Sueños
2. **ELIO** (9 años) - Luz
3. **NIA** (10 años) - Animales
4. **RAVI** (11 años) - Atraviesa
5. **ZARA** (12 años) - Tecnología
6. **JIN** (13 años) - Sombras
7. **MARCUS** (13 años) - Fuerza
8. **FATIMA** (14 años) - Escudos
9. **LÉA** (14 años) - Transforma
10. **TOMÁS** (15 años) - Velocidad
11. **YUKI** (15 años) - Hielo
12. **SAFIYA** (16 años) - Curación
13. **KAIDA** (18 años) - Fuego

---

## 🌟 Protagonistas (Personajes Jugables)
...
<div class="character-card" style="background-color: #eef; padding: 15px; border-left: 4px solid #00f;">
  <strong>🏃 MARCUS "EL COACH" WILLIAMS</strong><br>
...
<div class="character-card" style="background-color: #eef; padding: 15px; border-left: 4px solid #00f;">
  <strong>🛡️ VIKTOR KOZLOV</strong><br>
  Seguridad
</div>

<div class="character-card" style="background-color: #eef; padding: 15px; border-left: 4px solid #00f;">
  <strong>📚 DANIEL KWON</strong><br>
  Profesor
</div>

<div class="character-card" style="background-color: #fef; padding: 15px; border-left: 4px solid #90f;">
  <strong>🧠 ELENA MORA</strong><br>
  Profesora<br>
  ⭐ <em>Clave para libertad</em>
</div>

<div class="character-card" style="background-color: #efe; padding: 15px; border-left: 4px solid #0a0;">
  <strong>🌿 YUKI TANAKA</strong><br>
  Jardinero
</div>

<div class="character-card" style="background-color: #eee; padding: 15px; border-left: 4px solid #888;">
  <strong>🔧 HÉCTOR RUIZ</strong><br>
  Conserje<br>
  Ve y escucha todo
</div>
