...
*   **El Pacto con Anubis y el Regreso del Faraón (1 Marzo 2026)**:
    *   **[Sesión 44]({{ site.baseurl }}/campaigns/la-familia/session-44-summary/)**: Continuando tras la tregua con la Esfinge, el grupo convive brevemente con la criatura antes de seguir adelante. La Esfinge advierte "donde va no hay vuelta" y "No vayáis", pero el grupo la ignora. Registran un campamento abandonado de exploradores ingleses del siglo XX que buscaban la Fuente de la Eterna Juventud, obteniendo provisiones y un cuaderno de expedición revelador.
    *   Al descender por una escalera hacia la oscuridad, el entorno cambia y caen al **Mar de los Muertos**: un mar sin viento, sin peces, sin luna ni estrellas reconocibles. Las tiradas de orientación y académicas fallan. Átropos usa un efecto relativista para acelerar el movimiento sin agotar al grupo.
    *   Basándose en la mitología egipcia —solo los muertos conocen el camino— deciden que [Garra]({{ site.baseurl }}/characters/details/garra/) detenga su corazón temporalmente. La tirada del Faraón falla: **Garra muere de verdad**. Pero una luz emana de su pecho y señala la dirección. Siguiéndola, el grupo alcanza una isla con una entrada vigilada por dos gólems de piedra (7 puntos de protección), que derrotan apuntando a sus ojos como punto débil.
    *   La puerta de la isla se abre ante Garra. Dentro: un palacio y una estatua animada de **Anubis**. El corazón de Garra, pesado contra una pluma, se equilibra. Al estar muerta, Garra no puede ofrecer nada y Anubis la dirige hacia el más allá. Al negarse, aparece **Ammit** (el cocodrilo devorador). [El Faraón]({{ site.baseurl }}/characters/details/el-faraon/) interviene: ofrece su **servicio eterno a Anubis al morir** a cambio de que devuelva la vida a Garra. Anubis acepta, revive a Garra y trae al Faraón, que emerge brillando con el cuerpo plagado de caras —fruto de haber completado el ritual de las 2 millones de almas— y cae inconsciente.
    *   De regreso en Arcadia, [Mésmero]({{ site.baseurl }}/characters/details/mesmero/) despierta al Faraón (whisky Macallan y un Ducados sin filtro) y extrae la verdad: el pacto para obtener 2 millones de almas liberó al **Faraón Oscuro**, pues el alma del Faraón era el sello que lo contenía. El bastón cargado con la esencia de Bastet está perdido. Los "discípulos" (jóvenes concursantes de televisión) trabajan en conseguir cuerpos para las almas. Además, la hija de un MetaCorp que el Faraón mató busca venganza. El Faraón permanece en casa de Mésmero meditando.

*   **El Regreso al Templo (9 Noviembre 2025)**:
    *   **[Sesión 43]({{ site.baseurl }}/campaigns/la-familia/session-43/)**: [Átropos]({{ site.baseurl }}/characters/details/ana-montenegro-esfinge-atropos/) (transformada en armadura de aleación de oro), [Bate]({{ site.baseurl }}/characters/details/bate/) y [Garra]({{ site.baseurl }}/characters/details/garra/) regresan al templo egipcio moderno. [Bate]({{ site.baseurl }}/characters/details/bate/) destruye cámaras de seguridad usando latrocinio volador para no cometer delito público.
    *   [Átropos]({{ site.baseurl }}/characters/details/ana-montenegro-esfinge-atropos/) rompe la cerradura con sus poderes. Dentro encuentran un templo con luces LED y **faraones zombis/esqueletos momificados** que atacan moviéndose como muñecos de *Jason y los Argonautas*.
    *   [Garra]({{ site.baseurl }}/characters/details/garra/) protege al grupo con su escudo telequinético. [Bate]({{ site.baseurl }}/characters/details/bate/) usa su **bate de arcanita** en un **ataque salvaje** destruyendo cuatro de cinco esqueletos instantáneamente, reventándolos en nubes de arena.
    ...
    *   Al abrir una puerta de piedra antigua, un **portal negro los absorbe** con una fuerza irresistible. [Átropos]({{ site.baseurl }}/characters/details/ana-montenegro-esfinge-atropos/) lo identifica y se deja arrastrar, seguida por sus compañeros.
    ...
    *   [Bate]({{ site.baseurl }}/characters/details/bate/) casi es succionado por un **agujero negro** cerca del vacío, agarrándose justo a tiempo. Descubren que el abismo tiene poder de absorción que hace volar muy peligroso.
    *   El grupo cruza un **puente de piedras flotantes** tipo plataformas, evitando un "círculo verde misterioso" que devuelve la mirada. [Garra]({{ site.baseurl }}/characters/details/garra/) lanza a los compañeros usando telequinesis para superar saltos difíciles.
    ...
    *   Durante el combate, [Garra]({{ site.baseurl }}/characters/details/garra/) intenta atrapar a la Esfinge con un campo de fuerza (tirada de Control: 16), pero la criatura usa un **ataque mental** que la distrae, haciéndole perder concentración y el escudo.
    *   [Bate]({{ site.baseurl }}/characters/details/bate/) golpea a la Esfinge con su bate, pero la criatura usa un Benny para absorber daño, quedando **aturdida**.
    *   [Átropos]({{ site.baseurl }}/characters/details/ana-montenegro-esfinge-atropos/) aprovecha el aturdimiento para **inclinarse en reverencia** y suplicar perdón en voz alta, negando ser saqueadora a pesar de no entender el idioma de la Esfinge.
