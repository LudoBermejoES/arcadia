...
- **Inteligencia**: d10 (brillante, estratega)
- **Espíritu**: d10 (voluntad férrea, carismática)
- **Fuerza**: d4 (físicamente débil)
- **Vigor**: d6 (resistencia normal)

### **Habilidades Destacadas**
- **Academics d6**: Educación buena
- **Common Knowledge d8**: Entiende dinámicas sociales
- **Focus d10**: Concentración excepcional para poderes
- **Intimidation d8**: Presencia amenazante cuando quiere
- **Notice d10**: Observadora experta de lenguaje corporal
- **Persuasion d12**: Maestra de manipulación verbal
...
### **Ventajas (Edges)**
- **Charismatic**: +1 a Persuasion, irresistiblemente encantadora
- **Attractive**: +1 a Performance y Persuasion, hermosa
- **Super Powers**: Poderes mentales múltiples

### **Desventajas (Hindrances)**
- **Mean (Minor)**: Disfruta causar sufrimiento emocional
- **Curious (Major)**: Debe saber TODO sobre todos, no puede resistir secretos
- **Arrogant (Minor)**: Se cree más inteligente que cualquiera

## Equipamiento

### **Uniforme del Correccional**
- **Estado**: Modificado para verse más atractivo
- **Estilo**: Lleva el uniforme con elegancia que otros no logran

### **Collar Inhibidor (Lo Odia)**
- **Resistencia Emocional**: Cuando está activo, siente "vacío" insoportable
- **Dependencia**: Adicta a sentir emociones de otros
- **Trauma del Collar**: Activarlo es tortura psicológica para ella

### **Diario Personal**
- **Contenido**: Registros de manipulaciones y observaciones
- **Código**: Escrito en mezcla de ewe (Ghana) y créole (Haití)
- **Secreto**: Si alguien lo lee, descubriría todas sus manipulaciones
...
### **Arco de Humanización**
- **Conflicto**: Aprender que las personas son más que emociones para manipular
- **Catalizador**: Alguien que genuinamente se preocupa pese a sus actos
- **Obstáculo**: Su poder hace imposible saber si conexiones son reales
- **Resolución Potencial**: Aprender a usar poderes para empatía real, no control

### **Arco de Identidad**
- **Crisis**: ¿Quién es sin manipulación?
- **Exploración**: Tiempo con collar inhibidor forzándola a ser "ella"
- **Descubrimiento**: Encontrar personalidad real debajo de las máscaras
- **Transformación**: Construir identidad propia

### **Arco de Redención**
- **Reconocimiento**: Comprender daño real que causó
- **Culpa**: Primer experiencia genuina de remordimiento
- **Reparación**: Usar poderes para sanar daño emocional en lugar de causarlo
- **Perdón**: Aprender a perdonarse a sí misma

## Potencial Narrativo

### **Como Protagonista**
- **Villana Trágica**: Monstruo creado por trauma generacional
- **Evolución Empática**: De manipuladora a sanadora emocional genuina
- **Lucha Interna**: Adicción a control vs deseo de conexión real
- **Redención Difícil**: Daño causado no se borra fácilmente

### **Como Antagonista**
- **Puppet Master**: Controla correccional desde las sombras
- **Reina del Caos**: Orquesta motines y tragedias por diversión
- **Monstruo Empático**: Usa comprensión de emociones para tortura psicológica
- **Irreversible**: Demuestra que algunos no pueden ser salvados

### **Como Aliada Compleja**
- **Espía Emocional**: Detecta mentiras y agendas ocultas
- **Negociadora**: Manipula emociones para desescalar conflictos
- **Información**: Lee estados emocionales de enemigos
- **Riesgo Constante**: Nunca se sabe si está ayudando o manipulando
