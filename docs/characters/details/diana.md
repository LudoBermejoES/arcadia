...
- Ataques directos devastadores
- Combate cuerpo a cuerpo efectivo
- Demolición precisa (colapso de estructuras)

**Estilo de Pelea**:
- "Elemento de ataque pesado" del grupo
- Enfoque directo y sin complicaciones
- Efectividad letal como "finalizadora"
- Combinación con Eslizón y Hotman en ataques múltiples

### Manifestaciones Extremas

**Furia "Saiyan"** (primer episodio: 24 Agosto 2025):
- Aura visible durante estados de furia extrema
- Desencadenado por trauma físico
...
- Supresores químicos anulan completamente sus poderes
- Primera herida real causó crisis emocional severa
- Reacciones desproporcionadas ante vulnerabilidad física
...
- Conexión telepática natural con su hermano gemelo Apolo
- Instintos violentos que emergen bajo trauma

**Elección**:
- Unirse a La Fuerza Oculta representa divergencia del destino criminal planificado
- Construcción de identidad independiente de Fatum
- Distanciamiento activo de la organización villana

### El Hermano Gemelo: Apolo

**Revelación** (29 Septiembre 2025):
- Destello telepático confirma que **Apolo está vivo**
- Conexión gemela trasciende distancia y lógica
- "Daba igual la distancia, daba igual la lógica, lo imposible"

**Implicaciones**:
- Ya no puede refugiarse en la ausencia/nada
- Duelo por Apolo reabierto sin posibilidad de cierre
- Pregunta constante: ¿Dónde está? ¿Debería buscarlo?
...
- Habitación con "altar, libros y posters de asiáticos gotiquillos y Quintus"
- Forma parte del equipo 2 de combate (con Astrid y Justa)

**Personalidad Inicial**:
- Contemplativa con estética gótica asiática
- Sugerencia de establecer guarida en el Barrio Gótico
- Efectividad demostrada en entrenamientos

### Fase II: Profesionalización Táctica (Julio-Agosto 2025)

**Operación Metro** (Julio 2025):
- Ataque directo que deja inconsciente a enemigo armado
- Coordinación perfecta con Eslizón y Hotman
- Reconocida como alguien que "no falla" en situaciones críticas

**Les Enfant Terribles** (17 Agosto):
- **Intervención protectora**: Noqueó a Psique para evitar que se dañara por sobreesfuerzo telepático
- Intento de infiltración haciéndose pasar por miembro del grupo enemigo
- "Salto heroico" desde piso superior como entrada dramática
- Coordinación con Sentencia sin comunicación

### Fase III: Crisis y Vulnerabilidad (Agosto 2025)

**Gorilas Dorados - Primer Trauma** (24 Agosto):
- **Primera herida real**: Golpe devastador que la lanza a los pies de Psique
- Despertar furioso con **aura visible "Saiyan"**
- Destrucción total del gorila: "lo revienta"
- Psique expresa alarma: "Tenemos que hablar"

**Implicaciones del Trauma**:
- Descubrimiento de vulnerabilidad física
- Manifestación de posible herencia genética violenta
- Necesidad de asistencia de Eslizón para moverse
- Primera vez dependiendo de otros

### Fase IV: Solidaridad y Violencia Expresiva (Septiembre 2025)

**Crisis Hospitalaria** (28 Septiembre):
- Zancadillas a Metacorps durante escape de Sentencia
- Defiende a Hotman: "No ha atacado a nadie, se ha defendido"
- **La silla estrellada**: Destruye silla contra cristal en solidaridad con Justa criticada

**Proyecto Personal**:
- Trabajo en Hero Forge: modelo de fusión Diana-Justa
- Creatividad como procesamiento de dinámicas grupales

**Revelación de Apolo** (29 Septiembre):
- Destrucción del tercer saco de entrenamiento buscando paz
- Destello telepático: "Apolo estaba allá, en algún sitio"
- Grito de negación, rechazo temporal de Psique
- "No, por favor, ahora no"
- Lágrimas contradictorias: terror y maravilla mezclados

### Fase V: Pérdida de Poderes (Noviembre 2025)

**Isla Sal** (16 Noviembre):
- Dardo supresor anuló completamente sus poderes
- Primera experiencia de impotencia total en combate
...
**[Psique/Cia]({{ site.baseurl }}/characters/details/mencia-psique-cia/)**:
- Único refugio donde muestra fragilidad y miedos
- Psique la noqueó para protegerla de sí misma
- Conversación post-Gorilas Dorados marcó un antes y después
- Ancla emocional que le permite desafiar destino de Fatum
- Primer rechazo temporal tras revelación de Apolo
...
- Coordinación táctica efectiva sin comunicación
- Solidaridad expresada con silla estrellada
- Compañera de equipo de combate original

**[Eslizón]({{ site.baseurl }}/characters/details/eslizon-esmeralda/)**:
- La ayudó cuando estaba herida tras Gorilas Dorados
- Coordinación en ataques múltiples
- Respeto mutuo basado en efectividad

**[Hotman]({{ site.baseurl }}/characters/details/hotman/)**:
- Coordinación táctica efectiva
- Defendió sus acciones: "Se ha defendido, no ha atacado"
...
**Su Refugio Mental** (antes de la revelación de Apolo):
...
**Destrucción como Paz**:
- Destruye sacos de entrenamiento buscando "remoto valle de tranquilidad"
- Solo el agotamiento físico extremo trae calma
- La violencia controlada es meditación

### Transformación por el Destello

**Antes**:
- Refugio en la nada como protección
...
- No puede cerrar el duelo
- Contradicción permanente: "algo terrible y algo maravilloso"

### Violencia como Lenguaje

**Expresión Emocional**:
- La silla estrellada: solidaridad sin palabras
- Zancadillas: apoyo táctico discreto
- Destrucción de sacos: meditación personal
- Furia "Saiyan": respuesta a vulnerabilidad
...
**Certezas**:
- Apolo está vivo en algún lugar
- Psique es su ancla emocional
- Su violencia puede canalizarse heroicamente

**Conflictos**:
- No puede refugiarse en la nada
...
> "Aquella oscuridad era su refugio, allí no había nada, nadie, no había más que ausencias."

> "La nada prometía protección contra la pérdida."

### Sobre Apolo

> "Daba igual la distancia, daba igual la lógica, lo imposible. Apolo estaba allá, en algún sitio y eso era, a la vez, algo terrible y algo maravilloso."
