...
- **Ataque directo devastador**: Ejecutó un ataque efectivo, dejando inconsciente a un enemigo armado
...
- **Atacante principal**: Especializada en eliminar amenazas mediante ataques directos y precisos
