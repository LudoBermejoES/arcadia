...
### **Estadísticas**
- **Agilidad**: d10 (reflejos de acróbata profesional)
- **Inteligencia**: d8 (astuto, calculador)
- **Espíritu**: d8 (confianza en sí mismo)
- **Fuerza**: d6 (físicamente promedio)
- **Vigor**: d6 (resistencia normal)

### **Habilidades Destacadas**
- **Atletismo d6**: Ágil pero no excepcional
- **Combate d4**: Evita pelea física
- **Focus d10**: Concentración perfecta para telequinesis
- **Percepción d10**: Observador experto
- **Sigilo d12**: Maestro del movimiento silencioso
- **Thievery d12**: Ladrón profesional
...
### **Ventajas (Edges)**
- **Acrobat**: Movimiento ágil, +1 a Parry cuando desarmado
- **Quick**: Descarta cartas de iniciativa de 5 o menos
- **Super Powers**: Poderes metahumanos activos

### **Desventajas (Hindrances)**
- **Greedy (Major)**: Obsesión por objetos de valor, no puede resistir oportunidad de robo
- **Arrogant (Minor)**: Se cree superior a otros, subestima oponentes
- **Quirk (Minor)**: Cleptomanía - roba incluso cuando no lo necesita

## Equipamiento

### **Uniforme del Correccional**
- **Estado**: Impecable, cuida su apariencia
- **Modificaciones**: Ha "adquirido" mejores botones y accesorios

### **Collar Inhibidor (Parcialmente Hackeado)**
- **Estado**: Ha intentado manipular su funcionamiento
- **Resultado**: Logró reducir efectividad en 15%
- **Riesgo**: Si lo descubren, enfrentará castigo severo
- **Uso Estratégico**: Guarda esta ventaja para emergencias

### **Ganzúas Escondidas**
- **Ubicación**: Cosidas en el dobladillo de su uniforme
- **Función**: Backup para cuando no puede usar poderes
- **Cantidad**: 3 ganzúas de diferentes tamaños
- **Artesanía**: Fabricadas con material robado del taller
...
### **Arco de Redención**
- **Conflicto**: ¿Puede ser más que un ladrón?
- **Influencias**: Otros internos que muestran vulnerabilidad
- **Momento Clave**: Elegir entre robo fácil o hacer lo correcto
- **Resolución Potencial**: Usar habilidades para ayudar en lugar de robar

### **Arco de Confianza**
- **Trauma**: Herencia familiar de traición institucional
- **Desafío**: Aprender que no todos lo traicionarán
- **Catalizador**: Alguien que lo protege sin esperar nada a cambio
- **Crecimiento**: Permitirse ser vulnerable

### **Arco del Maestro Ladrón**
- **Ambición**: Convertirse en el mejor ladrón de Arcadia
- **Entrenamiento**: Perfeccionar habilidades en el correccional
- **Dilema**: ¿Usar talento para bien o para mal?
- **Legado**: Decidir qué tipo de ladrón quiere ser

## Potencial Narrativo

### **Como Protagonista**
- **Antihéroe**: Ladrón con corazón (potencialmente)
- **Genio Criminal**: Planifica el robo perfecto
- **Transformación**: De ladrón egoísta a Robin Hood moderno
- **Desafío**: Usar inteligencia para resolver problemas sin robar

### **Como Antagonista**
- **Cerebro Criminal**: Organiza fugas y motines
- **Infiltrador**: Puede entrar donde otros no pueden
- **Manipulador**: Usa a otros para sus esquemas
- **Escape Artist**: Imposible de contener permanentemente

### **Como Aliado**
- **Especialista**: Experto en infiltración y adquisición
- **Planificador**: Estratega brillante para misiones complejas
- **Información**: Conoce cómo funcionan sistemas de seguridad
- **Versátil**: Telequinesis útil en múltiples situaciones
