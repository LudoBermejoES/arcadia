...
### **Estadísticas**
- **Agilidad**: d10 (se mueve como sombra)
- **Inteligencia**: d10 (brillante, introspectivo)
- **Espíritu**: d6 (frágil, inseguro de identidad)
- **Fuerza**: d6 (condición física promedio)
- **Vigor**: d6 (resistencia normal)

### **Habilidades Destacadas**
- **Atletismo d8**: Movimientos fluidos y silenciosos
- **Combate d8**: Lucha desde las sombras
- **Focus d10**: Concentración excepcional en manipulación de oscuridad
- **Notice d12**: Percepción aumentada en oscuridad
- **Sigilo d12**: Prácticamente invisible en sombras
- **Investigación d10**: Observador meticuloso
...
### **Ventajas (Edges)**
- **Super Powers**: Poderes metahumanos de sombra
- **Assassin**: Entrenado en movimiento silencioso y ataque desde oscuridad
- **Alertness**: Sentidos agudizados especialmente en oscuridad

### **Desventajas (Hindrances)**
- **Outsider (Major)**: Triple marginación - adoptado, hijo de familia LGBTQ+, metahumano
- **Quirk (Minor)**: Evita luz directa compulsivamente
- **Secretive (Minor)**: No comparte información personal fácilmente

## Equipamiento

### **Uniforme del Correccional en Tonos Oscuros**
- **Color**: Negro y gris oscuro en lugar del estándar
- **Función**: Le permite mimetizarse mejor con sombras
- **Modificación especial**: Aprobada por necesidad psicológica
- **Simbolismo**: Único interno con uniforme personalizado

### **Celda con Iluminación Regulable**
- **Control**: Puede ajustar luz desde completa oscuridad hasta penumbra
- **Necesidad**: Demasiada luz causa ansiedad severa
- **Compromiso**: Debe mantener luz mínima durante visitas de personal
- **Santuario**: Único lugar donde se siente completamente cómodo

### **Gafas de Sol Permanentes**
- **Uso**: Las lleva incluso en interiores
- **Función**: Reduce sensibilidad a luz y oculta ojos
- **Barrera**: Protección física y emocional
- **Identidad**: Parte integral de su apariencia
...
### **Arco de Identidad**
- **Objetivo**: Definir quién es más allá de marginaciones
- **Obstáculos**: Capas de "diferencia" que complican auto-comprensión
- **Progreso**: Explorando cada faceta de identidad separadamente
- **Setbacks**: Cada experiencia de rechazo refuerza inseguridad

### **Arco de Visibilidad**
- **Conflicto**: Miedo a ser visto vs necesidad de conexión
- **Desarrollo**: Permitiéndose ser visible en espacios seguros
- **Técnicas**: Exposición gradual a situaciones sociales
- **Evolución**: De invisible compulsivo a elección consciente de cuándo aparecer

### **Arco Familiar**
- **Situación**: Separado de padres que lo adoptaron y aman
- **Objetivo**: Reunificación y demostrar que su "crimen" fue protección
- **Obstáculos**: Sistema que no reconoce defensa familiar como justificación
- **Resolución potencial**: Liberación y reintegración familiar

## Potencial Narrativo

### **Como Protagonista**
- **Héroe oculto**: Hace bien sin buscar reconocimiento
- **Espía perfecto**: Misiones de infiltración y reconocimiento
- **Búsqueda de identidad**: Historia universal de encontrarse a sí mismo
- **Representación**: Visibiliza experiencias de adopción transracial y familias LGBTQ+

### **Como Antagonista**
- **Asesino de sombras**: Usa poderes para asesinatos imposibles de rastrear
- **Desaparición**: Se pierde completamente en oscuridad, renuncia a humanidad
- **Venganza oscura**: Ataca desde sombras a quienes persiguen comunidad LGBTQ+
- **Vacío**: Consume luz y esperanza, personifica depresión

### **Como Aliado**
- **Reconocimiento**: Observación e inteligencia desde las sombras
- **Infiltración**: Acceso a lugares sin detección
- **Rescate**: Extracción de personas usando viaje por sombras
- **Apoyo silencioso**: Ayuda sin necesidad de reconocimiento
