...
### **Estadísticas**
- **Agilidad**: d10 (increíblemente ágil y flexible)
- **Inteligencia**: d8 (perspicaz, observadora)
- **Espíritu**: d6 (identidad frágil, insegura)
- **Fuerza**: d6 (fuerza base varía con forma)
- **Vigor**: d8 (resistente, adaptable)

### **Habilidades Destacadas**
- **Atletismo d8**: Flexible y coordinada en cualquier forma
- **Engaño d10**: Maestra del engaño y la manipulación
- **Notar d10**: Observación excepcional de detalles físicos
- **Actuar d10**: Imita comportamientos y personalidades
- **Sigilo d10**: Infiltración perfecta cuando imita correctamente
- **Callejeo d8**: Conocimiento de supervivencia urbana
...
### **Ventajas (Edges)**
- **Charismatic**: Encantadora en cualquier forma que adopte
- **Super Powers**: Poderes metahumanos de cambio de forma
- **Attractive**: Puede hacerse hermosa a voluntad
- **Thief**: Habilidades de infiltración y robo desarrolladas

### **Desventajas (Hindrances)**
- **Identity Crisis (Major)**: No está segura de quién es realmente
- **Habit (Minor)**: Cambia de forma compulsivamente cuando está ansiosa
- **Loyal (Minor)**: Haría cualquier cosa por su familia

## Equipamiento

### **Uniforme del Correccional**
- **Estado**: Cambia constantemente de apariencia con ella
- **Marca especial**: Insignia imposible de transformar que la identifica
- **Material**: Diseñado para cambiar con sus transformaciones

### **Insignia de Identificación No-Transformable**
- **Función**: Broche metálico que no puede incorporar en transformaciones
- **Tecnología**: Aleación especial visible en cualquier forma
- **Propósito**: Identificarla incluso cuando se transforma
- **Ubicación**: Debe llevarlo visible en todo momento

### **Collar Inhibidor de Poderes**
- **Función**: Anula poderes y la fuerza a mantener forma "base"
- **Control**: Administrado por el Señor Nadie
- **Efectos secundarios**: Sensación de "estar atrapada en una máscara"
- **Uso**: Activado cuando hay sospecha de intentos de escape
...
### **Arco de Identidad**
- **Objetivo**: Descubrir quién es sin las transformaciones
- **Obstáculos**: Miedo a que no haya "yo real" debajo
- **Progreso**: Terapia forzándola a mantener forma base
- **Setbacks**: Cada transformación refuerza disociación

### **Arco de Autenticidad**
- **Conflicto**: Supervivencia mediante engaño vs conexión mediante honestidad
- **Exploración**: Intentos de mostrarse "real" a personas selectas
- **Riesgo**: Cada muestra de autenticidad la hace vulnerable
- **Resolución potencial**: Aceptar que la fluidez ES su identidad auténtica

### **Arco Moral**
- **Situación**: ¿Estaba justificado usar poderes para robar?
- **Dilemas**: Responsabilidad personal vs necesidad de supervivencia
- **Crecimiento**: De víctima de circunstancias a agente de cambio
- **Evolución**: Encontrar formas de ayudar sin cruzar líneas éticas

## Potencial Narrativo

### **Como Protagonista**
- **Búsqueda de identidad**: Historia universal de autodescubrimiento
- **Refugiada ingeniosa**: Celebración de resiliencia y adaptación
- **Maestra del disfraz**: Narrativas de espionaje e infiltración
- **Humanidad bajo máscaras**: Exploración de autenticidad vs performance

### **Como Antagonista**
- **Infiltradora perfecta**: Puede ser cualquiera, estar en cualquier lugar
- **Suplantación masiva**: Destruye confianza en sociedad
- **Robo de identidad literal**: Arruina vidas adoptando identidades
- **Pérdida total de humanidad**: Convertida en espejo vacío

### **Como Aliada**
- **Espía incomparable**: Infiltración y extracción de información
- **Distracción perfecta**: Puede hacer que enemigos persigan fantasmas
- **Rescates**: Suplanta autoridad para liberar prisioneros
- **Versatilidad táctica**: Se adapta a cualquier rol necesario
