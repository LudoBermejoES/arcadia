...
### **Estadísticas**
- **Agilidad**: d6 (movimientos cuidadosos por su fuerza)
- **Inteligencia**: d8 (brillante académicamente)
- **Espíritu**: d10 (determinación y valentía excepcionales)
- **Fuerza**: d12+4 (fuerza sobrehumana extrema)
- **Vigor**: d10 (resistencia superior)

### **Habilidades Destacadas**
- **Atletismo d8**: Físicamente excepcional
- **Combate d4**: Evita pelear por miedo a matar
- **Idiomas d8**: Bilingüe inglés-portugués
- **Intimidación d10**: Presencia imponente natural
- **Notice d8**: Observador y atento a injusticias
- **Persuasión d8**: Líder natural y orador

### **Pace**: 6 | **Parry**: 4 | **Toughness**: 10

## Ventajas y Desventajas

### **Ventajas (Edges)**
- **Brave**: Valiente ante autoridad y peligro
- **Super Powers**: Múltiples poderes físicos sobrehumanos
- **Natural Leader**: Otros niños lo siguen y respetan

### **Desventajas (Hindrances)**
- **Pacifist (Major)**: Rechaza violencia, pese a tener poder para ejercerla
- **Heroic (Major)**: No puede ignorar personas en peligro
- **Vow (Minor)**: Juró usar su fuerza solo para defender, nunca atacar

## Equipamiento

### **Uniforme del Correccional Reforzado**
- **Material**: Tejido especial ultra-resistente
- **Durabilidad**: Reemplazado cada dos semanas porque lo rompe accidentalmente
- **Ajuste**: Hecho a medida para su tamaño superior al promedio

### **Guantes de Contención**
- **Función**: Limitan fuerza en tareas delicadas
- **Efectividad**: Permite manipular objetos frágiles sin romperlos
- **Comodidad**: Detesta usarlos, se siente "enjaulado"
- **Uso**: Obligatorios durante clases y comidas

### **Collar Inhibidor de Poderes**
- **Función**: Reduce fuerza a niveles humanos normales
- **Control**: Administrado por el Señor Nadie
- **Efectos secundarios**: Sensación de "debilidad" y vulnerabilidad
- **Uso**: Durante terapia para practicar contacto humano seguro
...
### **Arco de Control**
- **Objetivo**: Aprender control fino de fuerza para contacto humano seguro
- **Obstáculos**: Miedo arraigado a lastimar a otros
- **Progreso**: Ejercicios con objetos cada vez más delicados
- **Meta**: Poder abrazar a su hermano sin miedo

### **Arco de Liderazgo**
- **Conflicto**: No busca poder pero otros lo siguen naturalmente
- **Desarrollo**: Aceptar rol de líder responsable
- **Dilemas**: ¿Usar influencia para cooperar o resistir al sistema?
- **Evolución**: De reluctante a consciente, líder que inspira

### **Arco de Justicia**
- **Situación**: Encarcelado injustamente por defenderse
- **Exploración**: ¿Trabajar dentro del sistema o desafiarlo?
- **Activismo**: Usando voz para cambiar políticas del correccional
- **Resolución potencial**: Convertirse en abogado de otros menores metahumanos

## Potencial Narrativo

### **Como Protagonista**
- **Héroe clásico**: Poder inmenso usado con responsabilidad extrema
- **Activista joven**: Lucha contra injusticia sistémica con ideales
- **Gigante gentil**: Subversión de tropo de "fuerza bruta"
- **Símbolo de resistencia**: Representa dignidad ante opresión

### **Como Antagonista**
- **Ruptura moral**: Pacifismo roto tras última injusticia
- **Fuerza desatada**: Destrucción masiva cuando control se pierde
- **Revolución violenta**: Lidera rebelión destructiva en correccional
- **Tragedia**: Héroe convertido en villano por sistema que debía protegerlo

### **Como Aliado**
- **Músculo moral**: Fuerza usada solo en legítima defensa
- **Protector de inocentes**: Escudo humano inquebrantable
- **Liderazgo**: Inspira y organiza grupos
- **Mediación**: Resuelve conflictos sin violencia
