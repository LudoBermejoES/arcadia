...
- [Session 05]({{ site.baseurl }}/campaigns/la-familia/session-05/)
- [Session 09]({{ site.baseurl }}/campaigns/la-familia/session-09/)
...
- [Session 19]({{ site.baseurl }}/campaigns/la-familia/session-19/)
- [Session 20]({{ site.baseurl }}/campaigns/la-familia/session-20/)
- [Session 21]({{ site.baseurl }}/campaigns/la-familia/session-21/)
- [Session 23]({{ site.baseurl }}/campaigns/la-familia/session-23/)
- [Session 24]({{ site.baseurl }}/campaigns/la-familia/session-24/)
- [Session 25]({{ site.baseurl }}/campaigns/la-familia/session-25/)
- [Session 26]({{ site.baseurl }}/campaigns/la-familia/session-26/)
- [Session 27]({{ site.baseurl }}/campaigns/la-familia/session-27/)
- [Session 28]({{ site.baseurl }}/campaigns/la-familia/session-28/)
- [Session 29]({{ site.baseurl }}/campaigns/la-familia/session-29/)
- [Session 31]({{ site.baseurl }}/campaigns/la-familia/session-31/)
- [Session 32]({{ site.baseurl }}/campaigns/la-familia/session-32/)
- [Session 34]({{ site.baseurl }}/campaigns/la-familia/session-34/)
- [Session 35]({{ site.baseurl }}/campaigns/la-familia/session-35/)
...
### Apariciones en Los 404

- [Sesión 15/03/2026]({{ site.baseurl }}/campaigns/los-404/ai-notes-summary/2026-03-15-gemini-notes/) - Primera aparición ante el grupo fugitivo del reformatorio; les recibe en su base del Barrio Gótico, les ofrece comida, y ya ha leído sus mentes antes de que hablen — su cara se queda pálida
