...
### **Estadísticas**
- **Agilidad**: d8 (ágil como animal salvaje)
- **Inteligencia**: d6 (educación interrumpida por trauma)
- **Espíritu**: d6 (frágil emocionalmente, traumatizada)
- **Fuerza**: d4 (pequeña, desnutrida en infancia)
- **Vigor**: d6 (resistencia de superviviente)

### **Habilidades Destacadas**
- **Atletismo d8**: Movimientos naturales, casi animales
- **Comunicación Animal d12**: Conexión perfecta con criaturas
- **Notice d10**: Sentidos agudizados por compartir percepción animal
- **Sigilo d10**: Se mueve silenciosamente como depredador
- **Supervivencia d8**: Instintos animales de subsistencia
- **Empatía d10**: Lee emociones (de animales y humanos)
...
### **Ventajas (Edges)**
- **Super Powers**: Poderes metahumanos de comunicación animal
- **Beast Master**: Control excepcional sobre animales
- **Danger Sense**: Animales la alertan de amenazas

### **Desventajas (Hindrances)**
- **Young (Major)**: Solo 10 años, necesita protección
- **Mute (Major)**: Mutismo selectivo - no habla con humanos
- **Phobia (Minor)**: Terror a espacios cerrados sin animales

## Equipamiento

### **Uniforme del Correccional**
- **Estado**: Cubierto de pelo animal constantemente
- **Modificaciones**: Bolsillos añadidos para transportar animales pequeños
- **Olor**: Perpetuamente huele a animales (no le importa)

### **Animal de Apoyo Emocional Autorizado**
- **Nombre**: Sombra (gato negro del correccional)
- **Función**: Compañero constante, intermediario con humanos
- **Permiso especial**: Único interno con animal permitido en celda
- **Vínculo**: Sombra "traduce" sus emociones a personal

### **Libreta de Comunicación**
- **Función**: Escribe para comunicarse con humanos
- **Contenido**: Mayormente dibujos de animales
- **Limitación**: Prefiere usar a Sombra como mensajero
- **Estado**: Llena de bocetos detallados de fauna
...
### **Arco de Rehumanización**
- **Objetivo**: Reconectarse con su humanidad sin perder conexión animal
- **Obstáculos**: Trauma asocia humanidad con abuso
- **Progreso**: Pequeñas interacciones humanas mediante animales
- **Setbacks**: Cualquier agresión humana refuerza aislamiento

### **Arco de Voz**
- **Conflicto**: Encontrar su voz sin necesidad de hablar
- **Exploración**: Formas alternativas de comunicación humana
- **Meta**: Hablar nuevamente con humanos dignos de confianza
- **Evolución**: De mutismo a elección consciente de cuándo hablar

### **Arco de Familia**
- **Situación**: Madre deportada, separadas por sistema
- **Búsqueda**: Encontrar manera de reunirse
- **Obstáculos**: Fronteras, burocracia, su estatus de interna
- **Resolución potencial**: Reunificación familiar usando poderes para escapar

## Potencial Narrativo

### **Como Protagonista**
- **Sobreviviente de tráfico**: Historia de resiliencia extrema
- **Dr. Dolittle heroica**: Aventuras mediante comunicación animal
- **Recuperación de trauma**: Viaje de sanación profunda
- **Puente entre mundos**: Conecta humanidad y naturaleza

### **Como Antagonista**
- **Reina de las bestias**: Ejército animal devastador
- **Venganza contra humanidad**: Desata fauna contra civilización
- **Eco-terrorista**: Libera animales de laboratorios y zoológicos
- **Niña salvaje perdida**: Renuncia completamente a humanidad

### **Como Aliada**
- **Red de espionaje animal**: Vigilancia mediante fauna urbana
- **Rescate de fauna**: Salva animales en peligro
- **Rastreo**: Usa sentidos animales para encontrar objetivos
- **Distracción**: Estampidas animales crean caos estratégico
