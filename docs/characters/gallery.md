...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const characterCategories = {
    ...
    reformatorio: [
      ...
      { slug: 'marcus-coach-williams', name: 'Marcus "Coach" Williams', image: 'Marcus Coach Williams.png' },
      { slug: 'hector-ruiz', name: 'Hector Ruiz (Conserje)', image: 'Hector Ruiz.png' },
      { slug: 'yuki-tanaka-jardinero', name: 'Yuki Tanaka (Jardinero)', image: 'Yuki Tanaka.png' },
  ...
  { slug: 'abismo', name: 'Abismo', image: 'abismo.png' },
    ...
    civiles: [
      ...
      { slug: 'nicolas-nicasio', name: 'Nicolás Nicasio', image: 'nicolas-nicasio.png' },
