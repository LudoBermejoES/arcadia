...
**El Distrito Gótico tiene una característica única y perturbadora: crece de forma autónoma.** Originalmente era una pequeña sección dentro del **Distrito Solis**, pero durante las últimas décadas ha experimentado una expansión misteriosa e impredecible.

**Proceso de "Consumo Distrital":**
- **Distrito Solis**: Ha perdido aproximadamente el 40% de su territorio original al Gótico
- **Distrito Lunae**: Sectores enteros de hospitales han sido "absorbidos", transformándose en clínicas góticas
- **Distrito Saturni**: Instalaciones metahumanas han sido integradas al ecosistema gótico

**Mecanismo desconocido:** Las autoridades no comprenden completamente cómo ocurre esta expansión. Los edificios parecen "transformarse" gradualmente, adoptando la arquitectura gótica característica, mientras que los residentes reportan que "el barrio los llama" antes de mudarse voluntariamente.

**Estado actual:** Lo que comenzó como un barrio específico ahora se extiende de forma irregular por múltiples zonas, creando "enclaves góticos" dentro de otros distritos residenciales.
...
**Transformación histórica:** Lo que comenzó como el corazón cultural de Arcadia ha visto cómo barrios enteros se transforman gradualmente en arquitectura gótica. Los residentes más antiguos recuerdan plazas soleadas que ahora son callejones sombríos, y mercados familiares que se han convertido en comercios místicos.

**Características principales:**
- Población: ~850,000 habitantes (reducida desde ~1.4 millones)
- Enfoque: Vivienda familiar, preservación cultural frente a la expansión gótica
- Servicios: Centros comunitarios, bibliotecas públicas, mercados de barrio tradicionales
- Instituciones: Centro de Tradiciones Culturales, Escuelas Primarias, Centros de Mayores

### 🌙 **DISTRITO LUNAE** (Lunes)
Distrito residencial de servicios sanitarios y asistenciales, donde se concentra la infraestructura médica y de cuidados de Arcadia. Diseñado para facilitar el acceso a servicios de salud, tanto para humanos como para metahumanos con necesidades especiales. **Sectores enteros del distrito han sido "absorbidos" por la expansión del Distrito Gótico, transformando hospitales modernos en clínicas de estética gótica.**

**Impacto de la transformación gótica:** Los servicios médicos afectados han adoptado características misteriosas. Algunas clínicas góticas reportan tratamientos "alternativos" que funcionan de formas inexplicables, mientras que el personal médico en estas áreas desarrolla una comprensión intuitiva de medicina metahumana.

**Características principales:**
- Población: ~900,000 habitantes (reducida desde ~1.1 millones)
- Enfoque: Vivienda accesible, servicios sanitarios híbridos (convencionales y góticos)
...
Distrito residencial de clase media, donde viven profesionales, técnicos y empleados cualificados. Combina viviendas de calidad media-alta con servicios educativos avanzados y espacios para el desarrollo profesional.
...
Distrito residencial juvenil y estudiantil, centro de la vida universitaria y de los jóvenes profesionales. Alberga residencias estudiantiles, espacios de coworking y servicios orientados a la población joven de Arcadia.

**Características principales:**
- Población: ~800,000 habitantes
- Enfoque: Vivienda juvenil, servicios para estudiantes y jóvenes
- Servicios: Residencias universitarias, espacios de coworking, centros deportivos juveniles
- Instituciones: Campus Universitarios, Centros de Empleo Juvenil, Espacios Culturales Alternativos

### 🛡️ **DISTRITO SATURNI** (Sábado)
Distrito residencial de servicios de seguridad y emergencias, diseñado para albergar a bomberos, policías, servicios de rescate y personal de emergencias. Incluye viviendas para trabajadores de servicios esenciales, estaciones de bomberos, comisarías y centros de coordinación de emergencias. **Sectores del distrito han sido progresivamente integrados al ecosistema gótico, creando una peculiar fusión entre servicios de emergencia convencionales y métodos góticos de protección comunitaria.**

**Integración gótica-emergencias:** Los sectores absorbidos por el Distrito Gótico han desarrollado métodos únicos de seguridad y rescate. Las patrullas nocturnas se adaptan al ambiente místico del barrio, y algunos servicios de emergencia reportan efectividad inexplicablemente alta en las zonas góticas.

**Características principales:**
- Población: ~550,000 habitantes (reducida desde ~700,000)
- Enfoque: Vivienda para personal de servicios esenciales, seguridad pública híbrida
- Servicios: Estaciones de bomberos, comisarías, centros de emergencias, servicios de rescate
- Instituciones: Academia de Servicios de Emergencia, Coordinación de Seguridad Pública, Centros de Entrenamiento de Rescate, Patrullas Góticas

### **Conectividad Inter-Distrital**
Los siete distritos residenciales están conectados entre sí y con los distritos especializados mediante:
- **Red de transporte público**: Metro, autobuses y tranvías
- **Ciclovías integradas**: Rutas para bicicletas que cruzan todos los distritos
- **Corredores comerciales**: Arterias principales con comercios y servicios
- **Red de comunicaciones**: Sistema integrado de telecomunicaciones

**Población total de los distritos residenciales: ~6.8 millones de habitantes**
*(Reducción debido a la expansión del Distrito Gótico, que aunque absorbe territorio, mantiene densidad poblacional diferente)*
